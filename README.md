...
RShiny: [![Binder](http://mybinder.org/badge_logo.svg)](http://mybinder.org/v2/gh/mxrtinez/proyectoE1-23/master?urlpath=shiny/bus-dashboard/)
...
name of the repository, placing instead a hyphen (the reason is that spaces are converted to `%20`).
  ...
  - Example: http://mybinder.org/v2/gh/mxrtinez/proyectoE1-23/master?urlpath=shiny/bus-dashboard/
